...
<table style=" margin:auto; width:1000px; height:500px; padding-right: 350px;">
	<tr bordercolor="white" style="height:10px; color:white;">
		<td style="text-align: center"> 
		<h1 style="font-family: fantasy; font-size: 30pt; color:gray;">리뷰 검색 결과</h1>
		</td>
	</tr>
	<tr style="height:300px; color:white;">
		<td style="text-align: center;"> 
			<table style=" color:white; width:1100px; margin:auto; "> 
				...
				<c:forEach var="wr" items="${WatchaReviews }">
				<tr style="height:50px; border-bottom-style:dotted; border-color:white; text-align: center;">
					...
					<td style="width:50px;" >
					<fmt:formatDate value="${wr.date }" type="both" dateStyle="short" timeStyle="short"/><br>
