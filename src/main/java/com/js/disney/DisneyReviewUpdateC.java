...
@WebServlet("/DisneyReviewUpdateC")
public class DisneyReviewUpdateC extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		AccountDAO.loginCheck(request);
		DisneyReviewDAO.getDrdao().getReview(request);
		request.setAttribute("contentPage", "disney_jsp/disney_review_update.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AccountDAO.loginCheck(request);
		DisneyReviewDAO.getDrdao().updateReview(request);
